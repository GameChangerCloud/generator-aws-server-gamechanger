...
module.exports = class extends Generator {
    ...
    writing() {
        ...
        this.fs.copyTpl(this.templatePath('database/sqlUtils.ejs'), this.destinationPath('database/sqlUtils.js'), {
            tables: this.tables
        });
        ...
        for (let index = 0; index < this.types.length; index++) {
            ...
            if (index == 0) {
                this.fs.copyTpl(this.templatePath('graphql/directives/directivesOnTypes.ejs'), this.destinationPath('directives/directivesOnTypes.js'), {
            ...
            if (graphqlType === "GraphQLInterfaceType") {
                ...
                if (!this.defaultScalars.includes(currentType.typeName)) {
                    this.fs.copyTpl(this.templatePath('graphql/typeScalar.ejs'), this.destinationPath('graphql/types/' + currentType.typeName.toLowerCase() + '.js'));
                }
            }
                ...
                if (currentType.typeName === "Query") {
                    this.fs.copyTpl(this.templatePath('graphql/query.ejs'), this.destinationPath('graphql/types/query.js'), {
                    ...
                    this.fs.copyTpl(this.templatePath('graphql/mutation.ejs'), this.destinationPath('graphql/types/mutation.js'), {
                        defaultScalars: this.defaultScalars,
                        types: this.types,
                        fields: currentType.fields,
                        otherMutation: fieldsParsed
                ...
                if (!isQuery && currentType.typeName !== "Mutation") {
                    ...
                    this.fs.copyTpl(this.templatePath('database/typeHandler.ejs'), this.destinationPath('database/handlers/handler' + currentType.typeName + '.js'), {
                    ...
                    this.fs.copyTpl(this.templatePath('graphql/directives/directiveResolvers.ejs'), this.destinationPath('database/utils/' + currentType.typeName.toLocaleLowerCase() + 'DirectiveResolvers.js'), {
        ...
        this.fs.copyTpl(this.templatePath('graphql/schema.ejs'), this.destinationPath('graphql/schema.js'), paramsSchema);
        this.fs.copyTpl(this.templatePath('graphql/defaultScalarsMap.ejs'), this.destinationPath('graphql/defaultScalarsMap.js'));
        //Adding the handler.js file (main handler)
        this.fs.copyTpl(this.templatePath('database/globalHandler.ejs'), this.destinationPath('database/handler.js'), {
            tables: this.tables
        });
        //Adding the utils file for the database
        this.fs.copyTpl(this.templatePath('database/utils.ejs'), this.destinationPath('database/utils/index.js'));
        //Adding files for managing Scalars
        this.fs.copyTpl(this.templatePath('../scalars/scalars.js'), this.destinationPath('database/utils/scalars.js'));
        this.fs.copyTpl(this.templatePath('../scalars/manageScalars.js'), this.destinationPath('database/utils/manageScalars.js'));
        //Adding RuntimeDirectiveResolver
        this.fs.copyTpl(this.templatePath('graphql/runtimeDirectiveResolver.ejs'), this.destinationPath('database/utils/runtimeDirectiveResolver.js'));
        ...
        this.fs.copyTpl(this.templatePath('cleanDatabase/cleanTables.ejs'), this.destinationPath('cleanDatabase/cleanTables.js'), {
            tables: this.tables
        });
        // Adding the file which check if all tables exists in database
        this.fs.copyTpl(this.templatePath('existTable/existTable.ejs'), this.destinationPath('existTable/existTable.js'), {
            tables: this.tables
        });
        ...
        this.fs.copyTpl(this.templatePath('testLambdas/eventMaker.ejs'), this.destinationPath('events/initTable.json'), {
            fields: null,
            typeName: "inittable",
            typeQuery: "initTable"
        });
        this.fs.copyTpl(this.templatePath('testLambdas/eventMaker.ejs'), this.destinationPath('events/dropTables.json'), {
            fields: null,
            typeName: "droptable",
        ...
        if (this.override == true) {
            ...
            this.fs.copyTpl(this.templatePath('upgradeDatabase/upgradeDatabase.ejs'), this.destinationPath('upgradeDatabase/upgradeDatabase.js'), {
                tables: this.tables,
