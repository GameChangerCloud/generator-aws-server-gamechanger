...
{tableName: "Tweet", text: `ALTER TABLE "Tweet" ADD FOREIGN KEY ("Fk_User_id") REFERENCES "User" ("Pk_User_id") DEFERRABLE INITIALLY DEFERRED`},{tableName: "Tweet", text: `ALTER TABLE "Tweet" ADD FOREIGN KEY ("Fk_Stat_id") REFERENCES "Stat" ("Pk_Stat_id") DEFERRABLE INITIALLY DEFERRED`},]
/*******
